...
SET source2="\\GPAWEB\NightlyBuilds\openPDC\Beta-VS2012\Libraries\*.*"
SET target2="..\..\Source\Dependencies\openPDC"
...
%tfs% checkin %target2% /noprompt /recursive /comment:"VS2012: Updated openPDC dependencies."
...
%tfs% checkin "%sourcetools%DataMigrationUtility.exe" /noprompt /comment:"VS2012: Updated grid solutions framework tool: DataMigrationUtility."
%tfs% checkin "%sourcetools%HistorianPlaybackUtility.exe" /noprompt /comment:"VS2012: Updated openHistorian tool: HistorianPlaybackUtility."
%tfs% checkin "%sourcetools%HistorianView.exe" /noprompt /comment:"VS2012: Updated openHistorian tool: HistorianView."
