--  ----------------------------------------------------------------------------------------------------
--  SIEGate Data Structures for SQL Server - Gbtc
--
...
--       Script is based on SIEGate.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [SIEGate];
GO
ALTER DATABASE [SIEGate] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [SIEGate] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [SIEGate] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [SIEGate] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [SIEGate] SET ARITHABORT OFF 
GO
ALTER DATABASE [SIEGate] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [SIEGate] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [SIEGate] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [SIEGate] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [SIEGate] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [SIEGate] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [SIEGate] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [SIEGate] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [SIEGate] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [SIEGate] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [SIEGate] SET  ENABLE_BROKER 
GO
ALTER DATABASE [SIEGate] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [SIEGate] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [SIEGate] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [SIEGate] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [SIEGate] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [SIEGate] SET  READ_WRITE 
GO
ALTER DATABASE [SIEGate] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [SIEGate] SET  MULTI_USER 
GO
ALTER DATABASE [SIEGate] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [SIEGate] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the SIEGate database.
...
--GO
--CREATE ROLE [SIEGateManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'SIEGateManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'SIEGateManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'SIEGateManagerRole'
--GO
