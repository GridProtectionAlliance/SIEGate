namespace Setup
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.radioButton64bit.Text = "64-bit version of the SIEGate";
            this.toolTip.SetToolTip(this.radioButton64bit, "The 64-bit version of the SIEGate is recommended for production deployments.\r\nThis" +
        " will require an available database such as SQL Server or MySQL.");
            ...
            this.radioButton32bit.Text = "32-bit version of the SIEGate";
            this.toolTip.SetToolTip(this.radioButton32bit, "If you do not have a database server installed locally you can always\r\ninstall th" +
        "e 32-bit version of the SIEGate and just use an Access database,\r\nno extra softwa" +
        "re required.");
